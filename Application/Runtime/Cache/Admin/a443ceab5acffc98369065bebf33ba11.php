		...
		<div class="pageTop">
			<div class="page">
				<img src="/seeworld/Public/Admin/img/coin02.png" /><span><a href="<?php echo U('Admin/Index/main');?>">首页</a>&nbsp;-&nbsp;<a
					href="<?php echo U('Admin/Cat/catlist');?>">主题栏目</a>&nbsp;-</span>&nbsp;栏目添加
			</div>
		</div>
		<div class="page ">
			<!-- 会员注册页面样式 -->
			<div class="banneradd bor">
				...
				<form action="<?php echo U('Admin/Cat/catadd');?>" method="post" accept-charset="utf-8">
				<div class="baBody">
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;栏目名称：<input type="text" class="input3" name="cat_name" value="">
					</div>
					<div class="bbD">
<!-- 						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="hidden"
							class="input3" /> -->
					...
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;栏目介绍：&nbsp;<textarea name="cat_intro" cols="50" rows="5" >
