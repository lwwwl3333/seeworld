    ...
    <div class="pageTop">
        <div class="page">
            <img src="/seeworld/Public/Admin/img/coin02.png"/><span><a href="<?php echo U('Admin/Index/main');?>">首页</a>&nbsp;-&nbsp;<a
                href="<?php echo U('Admin/Rec/artlist');?>">独家推荐</a>&nbsp;-</span>&nbsp;文章添加
        </div>
    </div>
    <div class="page ">
        <!-- 上传广告页面样式 -->
        <div class="banneradd bor">
            ...
            <div class="baBody">
                <form action="<?php echo U('Admin/Rec/addart');?>" method="post" enctype="multipart/form-data">
                    <div class="bbD">
                        文章标题：<input type="text" class="input3" name="a_name"/>
                    </div>
                    ...
                    <div class="bbD">
                        ...
                        <select class="input3" name="rec_id">
                            <?php if(is_array($recs)): foreach($recs as $key=>$rec): ?><option value="<?php echo ($rec['rec_id']); ?>"><?php echo ($rec['rec_name']); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                    <div class="bbD">
                        文章简介：<input type="text" class="input3" style="width:80%;" name="a_intro"/>
