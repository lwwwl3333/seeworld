...
(function (root, factory) {
    ...
    var defaults = {
            ...
            // 切换字符
            prev: '<i aria-hidden="true" class="fa fa-long-arrow-left"></i>',
            next: '<i aria-hidden="true" class="fa fa-long-arrow-right"></i>',
    ...
    function Calendar(element, options) {
        ...
        this.allowed_date = new Array();
        this.init();
        for (i in this.data)
        {
            this.allowed_date[i]=this.data[i].date;
        }
