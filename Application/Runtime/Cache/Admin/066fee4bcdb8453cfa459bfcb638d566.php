	...
	<div class="pageTop">
		<div class="page">
			<img src="/seeworld/Public/admin/img/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;<a
				href="<?php echo U('Admin/Travel/tralist');?>">旅行项目</a>&nbsp;-</span>&nbsp;出行时间添加
		</div>
	</div>
	<div class="page ">
		<!-- 会员注册页面样式 -->
		<div class="banneradd bor">
			...
			<div class="baBody">
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;项目名称：<input type="text" class="input3" name="tra_name" value="<?php echo ($t['tra_name']); ?>" readonly />
				</div>
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;出发时间：<input  class="input3" type="text" id="date_picker" readonly name="d_content">
				</div>
				<input type="hidden" name="tra_id" value="<?php echo ($t['tra_id']); ?>">
				</div>
				<div class="bbD">
					<p class="bbDP">
						<input type="submit" class="btn_ok btn_yes" value="添加">
						<a class="btn_ok btn_no" href="<?php echo U('Admin/Travel/tralist');?>">取消</a>
					</p>
				</div>
			</form>
			</div>
