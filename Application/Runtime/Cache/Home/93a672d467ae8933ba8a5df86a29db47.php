...
<div class="pro_list new_list">
	<div class="wrap1000">
		<div class="crumbs">
			<a href="<?php echo U('Home/Index/index');?>">首页</a> &gt;<a href="<?php echo U('Home/Rec/rec',['rec_id'=>$rid]);?>"><?php echo ($rname); ?></a>><?php echo ($art[a_name]); ?>
		</div>
		<div class="wrap_left">
			<div class="new_det">
				<h2 ><?php echo ($art[a_name]); ?></h2>
				<div class="tag">
					...
					<!-- JiaThis Button END -->
					<span class="pub_time"><?php echo (date("Y-m-d H:i:s",$art[pubtime])); ?></span>
					<div class="clear"></div>
				</div>
				<div class="new_det_text" style="margin-top: 20px;">
					<?php echo (htmlspecialchars_decode($art[a_content])); ?>
		</div>
			</div>
