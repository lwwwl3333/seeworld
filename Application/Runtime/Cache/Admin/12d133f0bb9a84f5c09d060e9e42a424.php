    ...
    <div class="pageTop">
        <div class="page">
            <img src="/seeworld/Public/admin/img/coin02.png" /><span><a href="<?php echo U('Admin/Index/main');?>">首页</a>&nbsp;-&nbsp;<a
                href="<?php echo U('Admin/Private/prilist');?>">私人定制</a>&nbsp;-</span>&nbsp;景点列表
        </div>
    </div>
            ...
            <div class="conform">
                <form>
                    ...
                    <div class="cfD">
                        ...
                        <a class="addA addA1" href="<?php echo U('Admin/Private/addpri');?>">添加分类+</a>
                        <a class="addA addA1" href="<?php echo U('Admin/Private/addjd');?>">添加景点+</a>
            ...
            <div class="conShow">
                <table border="1" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="200px" class="tdColor">景点名称</td>
                        <td width="200px" class="tdColor">所属分类</td>
                        <td width="300px" class="tdColor">景点简介</td>
                        <td width="175px" class="tdColor">点击量</td>
                        <td width="200px" class="tdColor">发布时间</td>
                        <td width="150px" class="tdColor">审核状态</td>
                    ...
                    <?php if(is_array($articles)): foreach($articles as $key=>$art): ?><tr>
                            ...
                            <td>
                                <p style="line-height: 25px;"><?php echo ($art['a_intro']); ?></p>
                            </td>
