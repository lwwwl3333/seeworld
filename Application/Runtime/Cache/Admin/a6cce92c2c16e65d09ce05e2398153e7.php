		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">			
					<div class="baBody">
						<div class="bbD">
							图片名称：<input  name="lun_name" type="text" class="input1" />
						</div>
						<div class="bbD">
							上传图片：
							<div class="bbDd">
						...
						<div class="bbD">
							是否显示：<label><input type="radio" checked="checked" value="1" name="lun_show" />是</label> <label><input type="radio" value="0" name="lun_show" />否</label>
						</div>
						<div class="bbD">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;选择栏目：
 							<!-- 遍历栏目 -->
